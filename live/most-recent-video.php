                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <video id="example_video_1" class="video-js vjs-default-skin"
                                ...
                                poster="https://amplify-smartsurveillance-dev-64534-deployment.s3-us-west-2.amazonaws.com/Watch+Hinomaruzumou+Episode+8+Via+Mobile.jpg">
                                <source src="'.$url.'" type="video/mp4" />
                                <!-- <source src="https://amplify-smartsurveillance-dev-64534-deployment.s3-us-west-2.amazonaws.com/Watch+Hinomaruzumou+Episode+8+Via+Mobile.webm" type="video/webm" /> -->
                            </video>
                        </div>
                    </div>
                </div>
