...
include_once "../../partials/layout_head.php";
	...
	if($_POST){
	    ...
	    if($user->emailExists()){
	        echo "<div class='alert alert-danger'>";
	            echo "The email you specified is already registered. Please try again or <a href='{$home_url}api/auth/login2.php'>login.</a>";
	        echo "</div>";
	    }
			...
			$user->status=1;
			$user->access_code = bin2hex(random_bytes(15)); 
			
			// create the user
			if($user->create()){
			 
			    echo "<div class='alert alert-info'>";
			        echo "Successfully registered. <a href='{$home_url}api/auth/login2.php'>Please login</a>.";
			    echo "</div>";
...
include_once "../../partials/layout_foot.php";
?>